...
ASCIIMaze::ASCIIMaze(unsigned int nx, unsigned int ny, bool full)
	: Maze(nx, ny, full), wall('#'), space(' '), center(' '), mark('@')
{}

void ASCIIMaze::print(unsigned int m_x, unsigned int m_y) const
{
